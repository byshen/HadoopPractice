...
public class SingleRecordWritable implements WritableComparable<SingleRecordWritable> {
	...
	public void set(long t_DID,RankPosition t_rankpositions){
		set(new LongWritable(t_DID),new FloatWritable(t_rankpositions.rank),new Text(t_rankpositions.getPosition()));
	}
